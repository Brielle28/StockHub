...
namespace StockHub_Backend.Interfaces
{
    public interface IPortfolioRepository
    {
        ...
        //for portfolio stock price updates
        Task<List<string>> GetAllPortfolioStockSymbolsAsync();
        Task<List<PortfolioStock>> GetAllPortfolioStocksAsync();
        Task UpdatePortfolioStockPricesAsync(List<PortfolioStockPriceUpdate> updates);
    }
}